...
data class ReportData(
    ...
    val totalPayableChecks: Long = 0,
    val totalReceivedChecks: Long = 0,
    ...
    val noteBoxCount: Int = 0,
    val payableCheckCount: Int = 0,
    val receivedCheckCount: Int = 0,
    val officeNoteCount: Int = 0,
    val officeReminderCount: Int = 0,
